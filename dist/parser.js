define(["require", "exports", "./error/invalid_syntax_error", "./nodes/call_node", "./nodes/number_node", "./nodes/string_node", "./nodes/var_access_node", "./nodes/return_node", "./nodes/continue_node", "./nodes/break_node", "./nodes/var_assign_node", "./nodes/unary_operation_node", "./nodes/ListNode", "./nodes/if_node", "./nodes/for_node", "./nodes/while_node", "./nodes/function_definition_node", "./nodes/binary_operation_node", "./parse_result", "./token_value"], function (require, exports, invalid_syntax_error_1, call_node_1, number_node_1, string_node_1, var_access_node_1, return_node_1, continue_node_1, break_node_1, var_assign_node_1, unary_operation_node_1, ListNode_1, if_node_1, for_node_1, while_node_1, function_definition_node_1, binary_operation_node_1, parse_result_1) {
    ...
    var Parser = /** @class */ (function () {
        ...
        Parser.prototype.reverse = function (amount) {
            if (amount === void 0) { amount = 1; }
            this.tok_idx -= amount;
            this.update_current_tok();
            return this.current_tok;
        };
        Parser.prototype.update_current_tok = function () {
        ...
        Parser.prototype.parse = function () {
            ...
            if ((!res.error) && this.current_tok.type != TT_EOF) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Token cannot appear after previous tokens"));
            }
            return res;
        };
        Parser.prototype.statements = function () {
            ...
            return res.success(new ListNode_1.ListNode(statements, pos_start, this.current_tok.pos_end.copy()));
        };
        Parser.prototype.statement = function () {
            ...
            if (this.current_tok.matches(TT_KEYWORD, "RETURN")) {
                ...
                return res.success(new return_node_1.ReturnNode(expr, pos_start, this.current_tok.pos_start.copy()));
            }
            if (this.current_tok.matches(TT_KEYWORD, "CONTINUE")) {
                res.register_advancement();
                this.advance();
                return res.success(new continue_node_1.ContinueNode(pos_start, this.current_tok.pos_start.copy()));
            }
            if (this.current_tok.matches(TT_KEYWORD, "BREAK")) {
                res.register_advancement();
                this.advance();
                return res.success(new break_node_1.BreakNode(pos_start, this.current_tok.pos_start.copy()));
            }
            expr = res.register(this.expr());
            if (res.error) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected 'RETURN', 'CONTINUE', 'BREAK', 'VAR', 'IF', 'FOR', 'WHILE', 'FUN', int, float, identifier, '+', '-', '(', '[' or 'NOT'"));
            }
        ...
        Parser.prototype.expr = function () {
            ...
            if (this.current_tok.matches(TT_KEYWORD, "VAR")) {
                ...
                if (this.current_tok.type != TT_IDENTIFIER) {
                    return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected identifier"));
                }
                var var_name = this.current_tok;
                res.register_advancement();
                this.advance();
                if (this.current_tok.type != TT_EQ) {
                    return this.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected '='"));
                }
                res.register_advancement();
                this.advance();
            ...
            var node = res.register(this.bin_op(this.comp_expr, [[TT_KEYWORD, "AND"], [TT_KEYWORD, "OR"]]));
            if (res.error) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected 'VAR', 'IF', 'FOR', 'WHILE', 'FUN', int, float, identifier, '+', '-', '(', '[' or 'NOT'"));
            }
        ...
        Parser.prototype.comp_expr = function () {
            ...
            if (res.error) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected int, float, identifier, '+', '-', '(', '[', 'IF', 'FOR', 'WHILE', 'FUN' or 'NOT'"));
            }
            return res.success(node);
        };
        Parser.prototype.arith_expr = function () {
        ...
        Parser.prototype.call = function () {
            ...
            if (this.current_tok.type == TT_LPAREN) {
                ...
                if (this.current_tok.type == TT_RPAREN) {
                    ...
                    if (this.current_tok.type != TT_RPAREN) {
                        return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected ',' or ')'"));
                    }
                    res.register_advancement();
                    this.advance();
                }
        ...
        Parser.prototype.atom = function () {
            ...
            if (tok.type == TT_INT || tok.type == TT_FLOAT) {
                ...
                if (this.current_tok.type == TT_RPAREN) {
                    ...
                    return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected ')'"));
                }
            }
        ...
        Parser.prototype.list_expr = function () {
            var res = new parse_result_1.ParseResult();
            var element_nodes = [];
            var pos_start = this.current_tok.pos_start.copy();
            ...
            return res.success(new ListNode_1.ListNode(element_nodes, pos_start, this.current_tok.pos_end.copy()));
        };
        ...
        Parser.prototype.if_expr_b = function () {
            return this.if_expr_cases('ELIF');
        };
        Parser.prototype.if_expr_c = function () {
            var res = new parse_result_1.ParseResult();
            var else_case = null;
            if (this.current_tok.matches(TT_KEYWORD, 'ELSE')) {
                ...
                if (this.current_tok.type == TT_NEWLINE) {
                    ...
                    if (this.current_tok.matches(TT_KEYWORD, 'END')) {
                        ...
                        return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected 'END'"));
                    }
                }
                else {
        ...
        Parser.prototype.if_expr_b_or_c = function () {
            var res = new parse_result_1.ParseResult();
            var cases = [];
            var else_case = null;
        ...
        Parser.prototype.if_expr_cases = function (case_keyword) {
            var res = new parse_result_1.ParseResult();
            var cases = [];
            var else_case = null;
            if (!this.current_tok.matches(TT_KEYWORD, case_keyword)) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected '{case_keyword}'"));
            }
            res.register_advancement();
            this.advance();
            ...
            if (!this.current_tok.matches(TT_KEYWORD, 'THEN')) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected 'THEN'"));
            }
            res.register_advancement();
            this.advance();
            if (this.current_tok.type == TT_NEWLINE) {
        ...
        Parser.prototype.for_expr = function () {
            ...
            if (!this.current_tok.matches(TT_KEYWORD, 'FOR')) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected 'FOR'"));
            }
            res.register_advancement();
            this.advance();
            if (this.current_tok.type != TT_IDENTIFIER) {
            ...
            if (!this.current_tok.matches(TT_KEYWORD, 'TO')) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected 'TO'"));
            }
            res.register_advancement();
            this.advance();
        ...
        Parser.prototype.while_expr = function () {
            ...
            if (!this.current_tok.matches(TT_KEYWORD, 'WHILE')) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected 'WHILE'"));
            }
            res.register_advancement();
            this.advance();
            var condition = res.register(this.expr());
        ...
        Parser.prototype.func_def = function () {
            var res = new parse_result_1.ParseResult();
            if (!this.current_tok.matches(TT_KEYWORD, 'FUN')) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected 'FUN'"));
            }
            res.register_advancement();
            this.advance();
            if (this.current_tok.type == TT_IDENTIFIER) {
                ...
                if (this.current_tok.type != TT_LPAREN) {
                    return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected identifier or '('"));
                }
            }
            res.register_advancement();
            this.advance();
            ...
            if (this.current_tok.type != TT_NEWLINE) {
                return res.failure(new invalid_syntax_error_1.InvalidSyntaxError(this.current_tok.pos_start, this.current_tok.pos_end, "Expected '->' or NEWLINE"));
            }
            res.register_advancement();
            this.advance();
        ...
        Parser.prototype.bin_op = function (func_a, ops, func_b) {
